...
logger = Logger('adam_inception_random.txt', title='cifar100')
...
if __name__ == '__main__':
    ...
    # optimizer = MomentumRandom(net.parameters(), lr=args.lr, momentum=0.9, weight_decay=5e-4)
    # optimizer = ZNDRandom(net.parameters(), lr=args.lr, momentum=0.9, weight_decay=5e-4)
    optimizer = AdamRandom(net.parameters(), lr=args.lr, betas=(0.9, 0.999), weight_decay=5e-4)
